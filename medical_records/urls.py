...
urlpatterns = [
    ...
    path('pets/<int:pet_pk>/add-record/', views.add_medical_record, name='add_record'),
    ...
    path('vaccinations/dashboard/', views.vaccination_dashboard, name='vaccination_dashboard'),
    path('vaccinations/dashboard/<int:pet_pk>/', views.vaccination_dashboard, name='vaccination_dashboard_pet'),
    
    # New: Medical History for Owners
    path('history/', views.medical_history, name='medical_history'),
    path('history/<int:pet_pk>/', views.medical_history, name='medical_history_pet'),
]

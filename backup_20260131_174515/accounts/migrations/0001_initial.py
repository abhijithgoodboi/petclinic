    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('VET', 'Veterinarian'), ('OWNER', 'Pet Owner'), ('RECEPTIONIST', 'Receptionist')], default='OWNER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_vet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='preferred_by', to='accounts.veterinarianprofile')),
            ],
        ),
    ]
